...
The changes in annual abundance of California Spiny Lobster at five sites were plotted to visualize (Figure 1). Spiny lobsters from all sites experienced an increasing trend in abundance except those from Arroyo Quemado, whose stock mainly stayed the same. The growing trend was especially apparent for lobster populations from Isla Vista and Naples, the Marine Protected Areas (MPA), then the other three sites, which are from non-MPA. 
