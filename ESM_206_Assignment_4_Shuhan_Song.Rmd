...
_**Table 1.** Summary of spiny lobster size for MPA and non-MPA sites in 2012 and 2018. For non-MPA sites, lobster size did not change much from 2012 (mean = 74.92, sd = 12.41, n = 199) to 2018 (mean = 73.62, sd = 10.09, n = 561). For MPA sites, lobster size increased between 2012 (mean = 67.38, sd = 12.15, n = 32) and 2018 (mean = 77.57, sd = 11.7, n = 1244). Data: SBC LTER_ 
```{r}
